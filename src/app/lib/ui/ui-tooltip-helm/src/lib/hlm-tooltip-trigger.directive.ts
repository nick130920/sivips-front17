    ...
    constructor() {
        if (this._brnTooltipTrigger) {
            ...
            this._brnTooltipTrigger.tooltipContentClasses =
                'overflow-hidden rounded-md border border-border w-max bg-popover ml-16 px-3 py-1.5 text-sm text-popover-foreground shadow-md fade-in-0 zoom-in-95 ' +
                'data-[state=open]:animate-in ' +
                'data-[state=closed]:animate-out ' +
                'data-[state=closed]:fade-out-0 ' +
                'data-[state=closed]:zoom-out-95 ' +
                'data-[side=below]:slide-in-from-top-2 ' +
                'data-[side=above]:slide-in-from-bottom-2 ' +
